<template>
  <div>
    <van-nav-bar :title="prodname" fixed :z-index="10"></van-nav-bar>
    <div class="nav-con">
      <!--顶部图片-->
      <van-image :src="setImg('assets/img/discovery/discovery_banner.jpg')" class="banner-img"></van-image>

      <!--中部内容-->
      <div style="padding: 10px">
        <div
          class="align-center commu-all"
        ...
        >
          ...
          <div class="commu-mid">
            ...
            <div
              class="light-txt commu-txt"
            >外交部领保中心常务副主任杨舒介绍了“26条措施”的第14条，台湾同胞可在中国驻外使领馆寻求领事保护与协助的途径...</div>
          </div>
      ...
      <van-row class="line2-all">
        <van-col span="12" v-for="(it, idx) in middleApps" :key="idx" class="line2-item click-box">
          <img :src="setImg('assets/img/discovery/'+it.icon)" class="line2-icon" />
          <div>
